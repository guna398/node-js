...
const mobiles = ["apple", "Samsung", "Realme"];
let text1 = "";
for (let x4 of mobiles) {
  text1 += x4 + "<br>";
}
console.log(mobiles);
...
const mymovie = new movie("Vikram", 2022);//objects
...
const Juices = ["Coffe","Tea","Milkshake","pineapple"];
...
setTimeout(function(){ myResolve("Hi... Guna"); }, 3000);
});
